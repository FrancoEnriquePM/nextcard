...
import heroImage from '../assets/nextcard-hero.jpg'; 
        ...
        >
            ...
            <div className="absolute z-10 bottom-0 left-0 max-w-md p-8 md:p-12"> 
                ...
                <p className="text-lg md:text-xl text-white/90 mb-8 drop-shadow">
                    Crea, comparte y gestiona <span className="text-accent font-semibold">NextCards</span> profesionales para tu equipo en segundos.
                </p>
