...
const CheckIcon = (props) => (
    <svg {...props} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" /></svg>
);
...
const Pricing = () => {
    const plans = [
        {
            ...
            recommended: false,
            features: [
                "Creación de NextCard personal",
                "Compartir vía QR y NFC",
        ...
        },
        {
            ...
            features: [
                "Todo en Esencial",
                "Monitoreo de Interacciones detallado",
    ...
    return (
        <section id="pricing" className="bg-white py-928">
            <div className="max-w-7xl mx-auto px-6 text-center">
                ...
                <div className="mb-16 max-w-3xl mx-auto">
                    ...
                    <p className="text-dark/70 text-xl">
                        Escala tus necesidades con estructuras de precios flexibles, diseñadas para equipos de cualquier tamaño.
                    </p>
                </div>
                ...
                <div className="grid md:grid-cols-3 gap-10">
                    {plans.map((plan, i) => (
                        <div
                            key={i}
                            // Estructura de la Tarjeta: Sombra dinámica y borde de enfoque.
                            className={`
                        ...
                        >
                            ...
                            {/* Precio */}
                            <p className={`text-5xl font-extrabold mb-1 ${plan.recommended ? "text-cyan-950" : "text-cyan-800"}`}>
                                {plan.price}
                            </p>
                            <p className={`text-sm mb-8 ${plan.recommended ? "text-cyan-900" : "text-cyan-800"}`}>
                                {plan.per}
                            </p>
                            ...
                            <ul className="text-left space-y-3 mb-10">
                                {plan.features.map((feature, idx) => (
                                    <li key={idx} className={`flex items-start gap-3 text-sm ${plan.recommended ? "text-cyan-900" : "text-cyan-800"}`}>
                                        <CheckIcon className={`w-5 h-5 flex-shrink-0 ${plan.recommended ? "text-cyan-950" : "text-cyan-800"}`} />
                                        {feature}
                                    </li>
                                ))}
                            </ul>
